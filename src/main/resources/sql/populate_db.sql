...
INSERT INTO products (name, default_price, default_currency, supplier_id, product_category_id, description) VALUES ('Time-Turner Necklace', 44, 'USD', 2, 1, 'The time-turner is centered with a miniature hourglass.');
INSERT INTO products (name, default_price, default_currency, supplier_id, product_category_id, description) VALUES ('Marauders Map', 30, 'USD', 2, 1, 'With this item, you will always know where your friends are.');
INSERT INTO products (name, default_price, default_currency, supplier_id, product_category_id, description) VALUES ('Wizarding Chess Set', 100, 'USD', 2, 1, 'A simple chess game with an epic twist.');
