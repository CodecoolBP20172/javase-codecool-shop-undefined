...
public class ProductCategoryDaoJdbc implements ProductCategoryDao {
    ...
    public void remove(int id) throws DaoException {
        ...
        try {
            PreparedStatement ps = (ConnectionManager.getConnection()).prepareStatement("DELETE FROM product_category WHERE id = ?;");
            ps.setInt(1, id);
            ps.execute();
    ...
    public List<ProductCategory> getAll() throws DaoException {
        ...
        try {
            PreparedStatement ps = (ConnectionManager.getConnection()).prepareStatement("SELECT * FROM product_category");
            ResultSet rs = ps.executeQuery();
